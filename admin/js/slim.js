$(function(){
  ...
  function checkEmail(email){
    ...
    var pattern = /[a-z0-9_\-\.]+@[a-z0-9_\-\.]+\.[a-z]{2,4}/ig;
    var myString = "This email pattern is required...'xxxxxxxx@xxxxxxx.xxx";
    var myCheck = pattern.test(email);
    if (myCheck === true) {
      // myEmail.style.border = "1px solid #000";
      // myEmail.style.backgroundColor = "#95B983";
      // myEmail.style.color = "white";
      // myEmail.style.padding ="10px";
      myPass.disabled = "";
