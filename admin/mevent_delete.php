    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          <h6 class="slim-pagetitle">DELETE MONTHLY EVENTS</h6>
        </div><!-- slim-pageheader -->

        <div class="section-wrapper">
          <label class="section-title">MONTHLY EVENTS INFO</label>
          ...
          <div class="modal-wrapper-demo">
              ...
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content bd-0">
                  ...
                  <div class="modal-footer justify-content-center">
                   <form method="post" action="mevent_delete.php">
            ...
            <div><h5>Click to view <a href="view_mevent.php">Monthly Events</a></h5>
          </form>
                  </div>
                </div>
              </div><!-- modal-dialog -->
