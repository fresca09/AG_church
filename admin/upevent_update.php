    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          <h6 class="slim-pagetitle">EDIT UPCOMING EVENTS</h6>
        </div><!-- slim-pageheader -->
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title" placeholder="Event Title" value="<?= $_GET['eTitle']; ?>">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="day" placeholder="Event day" value="<?= $_GET['eDay']; ?>">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Event day in number: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="day_no" placeholder="Event day in number" value="<?= $_GET['eDay_no']; ?>">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Event time: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="time" placeholder="Event time" value="<?= $_GET['eTime']; ?>">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="phone" placeholder="Event phone number(s)" value="<?= $_GET['ePhone']; ?>">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <input class="form-control" type="text" name="location" placeholder="Enter event location number" value="<?= $_GET['eLocation']; ?>">
                </div>
              </div><!-- col-8 -->
            ...
            <div class="row mg-b-25">
               <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <textarea class="form-control" name="body" placeholder="Enter home address" style="width: 400px; min-height: 200px; " value=""><?= $_GET['eDesc']; ?></textarea>
                </div>
              </div>
...
<!--              <button class="btn btn-secondary bd-1" style="width: 190px;">Cancel</button>-->
          ...
          <div style="padding-top: 10px;"><h5>Click to view <a href="view_upevent.php">Upcoming Events</a></h5>
          </div>
          </form>
        </div><!-- section-wrapper -->
